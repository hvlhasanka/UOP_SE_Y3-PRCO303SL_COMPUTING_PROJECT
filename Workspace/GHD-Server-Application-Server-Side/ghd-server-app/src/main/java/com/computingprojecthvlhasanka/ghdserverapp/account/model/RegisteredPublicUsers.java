/**
 * Model: RegisteredPublicUsers
 * Database Relation: 'registeredpublicusers'
 */
...
@Entity
@Table(name = "registered_public_users")
public class RegisteredPublicUsers {
